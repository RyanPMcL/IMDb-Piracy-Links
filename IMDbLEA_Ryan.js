...
(function (preact, hooks) {
  ...
  const VERSION = "Piracy Links vAlpha-3.2.2";
  ...
  var css$3 = {
    ...
    "layout-legacy": "Config_layout-legacy__M6fyd",
  ...
  const App = ({ imdbInfo }) => {
    ...
    return preact.h(
      preact.Fragment,
      null,
      imdbInfo.layout === "legacy" ? preact.h("hr", null) : null,
      preact.h(
        "div",
        {
